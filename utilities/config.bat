:: Wrapper: Offline For Schools Config
...
:: Tells settings.bat which port the frontend is hosted on. (If changed manually, you MUST also change the value of "SERVER_PORT" to the same value in wrapper\env.json) Default: 8000
set PORT=8000
